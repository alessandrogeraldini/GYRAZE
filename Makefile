...
renorm: MPS_renorm.o denscalc_renorm.o potupdate.o otherfuncs.o
	gcc -Wall -g -lgsl -lgslcblas -lm -o MPS_renorm MPS_renorm.o denscalc_renorm.o potupdate.o otherfuncs.o 
...
denscalc_renorm.o: denscalc_renorm.c
	gcc -Wall -g -c -o denscalc_renorm.o denscalc_renorm.c

MPS_renorm.o: MPS_renorm.c 
	gcc -Wall -c -o MPS_renorm.o MPS_renorm.c -g

MPS2d.o: MPS2d.c 
	gcc -Wall -g  -c -o MPS2d.o MPS2d.c

clean:
	rm MPS MPS_renorm MPS2d MPS2d.o MPS.o MPS_renorm.o denscalc.o denscalc_renorm.o potupdate.o otherfuncs.o
