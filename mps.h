...
void densfinorb(double Te, double lenfactor, double alpha, int size_phigrid, int *size_ngrid, double* n_grid, double* n_grid_corr_delta, double* n_grid_corr_chiM, double *x_grid, double* phi_grid, double charge, double **FF, double *mumu, double *UU, int sizemumu, int sizeUU, double grid_parameter, double *flux, double *Qflux, int zoomfactor, double stopdens, double phiDSbump, double *vy, double *mu_op, double *chiMax_op, double *dmudvy, int *size_op, char* dirname);
