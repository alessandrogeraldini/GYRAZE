...
int densfinorb(int dodistfunc, double Te, double alpha, int size_phigrid, int *size_ngrid, double* n_grid, double *x_grid, double* phi_grid, double rho_over_unitgrid, double temp_over_unitgrid, double charge, double **FF, double *mumu, double *UU, int sizemumu, int sizeUU) {
// DECLARATIONS
